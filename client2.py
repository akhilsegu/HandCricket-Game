...
background_image = pygame.image.load("H-C.png").convert()
class Button:
...
def redrawWindow(wind, game, p):
    ...
    if not (game.connected()):
        ...
        if p == 1:
            ...
            t_score1 = font.render(str(score2), 1, (25, 25, 112))
            t_score2 = font.render(str(score1), 1, (25, 25, 112))
        else:
            wind.blit(text1, (100, 350))
            wind.blit(text2, (400, 350))
            t_score1 = font.render(str(score1), 1, (25, 25, 112))
            t_score2 = font.render(str(score2), 1, (25, 25, 112))
        ...
        if game.done_bat[0] == 1 and game.done_bat[1] == 1:
            ...
            text0 = font.render("OPPONENT IS OUT", 1, (25, 25, 112))
            wind.blit(text0, (75, 100))
        elif game.done_bat[0] == 1 and game.get_player_score(1) == 0 and p == 0:
            text0 = font.render("YOU ARE OUT", 1, (25, 25, 112))
            wind.blit(text0, (75, 100))
...
btns = [Button("0",  75, 400, (255, 255, 255)),
        Button("1", 275, 400, (255, 255, 255)),
        Button("2", 475, 400, (255, 255, 255)),
        Button("3",  75, 525, (255, 255, 255)),
        Button("4", 275, 525, (255, 255, 255)),
        Button("6", 475, 525, (255, 255, 255)),]
    ...
    while run:
        ...
        if game.done_bat[0] and game.done_bat[1]:
            ...
            if (game.winner() == 1 and player == 1) or (game.winner() == 0 and player == 0):
                text = font.render("You Won!", 1, (25, 25, 112))
            elif game.winner() == -1:
                text = font.render("Tie Game!", 1, (25, 75, 112))
            else:
                text = font.render("You Lost...", 1, (25, 25, 112))
